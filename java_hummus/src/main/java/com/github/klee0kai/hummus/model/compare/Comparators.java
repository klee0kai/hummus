package com.github.klee0kai.hummus.model.compare;
...
public class Comparators {
    ...
    public static <T> Comparator<T> byNull(SortType sortType) {
    ...
    public static int nullsCompare(Object it1, Object it2, SortType sortType) {
    ...
    public static int stringCompare(String it1, String it2, SortType sortType) {
        int r = nullsCompare(it1, it2, sortType);
        if (r != 0) {
            return r;
        }
