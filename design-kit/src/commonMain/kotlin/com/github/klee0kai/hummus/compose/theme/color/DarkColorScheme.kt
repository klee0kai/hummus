...
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.background
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.coral
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.grayColor
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.green
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.lightBackground
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.noColor
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.orange
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.pink
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.surfaceColor
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.turquoise
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.violet
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.whiteColor
import com.github.klee0kai.hummus.compose.theme.color.DarkColorCollection.yellow
...
fun darkCommonColorScheme() = HummusColorScheme(
    isDark = true,
